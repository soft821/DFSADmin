...
class AddBlog extends Component {
  ...
  {
    this.sectionLastId = this.sectionLastId + 1;
    this.sections.push({id: this.sectionLastId, sectionTitle: 'title of the section', sectionSubTitle: 'subtitle of the section', sectionDescription: 'description of the section'});
    this.setState({sectionList: this.sections});
  ...
  handleSectionTitle(section_id, event){
    this.sections[section_id - 1].sectionTitle = event.target.value;
    this.setState({sectionsList: this.sections});
  }
  handleSectionSubTitle(section_id, event){
    this.sections[section_id - 1].sectionSubTitle = event.target.value;
    this.setState({sectionsList: this.sections});
  }
  handleSectionDescription(section_id, event){
    this.sections[section_id - 1].sectionDescription = event.target.value;
    this.setState({sectionsList: this.sections});
  }
